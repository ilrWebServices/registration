...
class EmailValidator extends EmailValidatorUtility implements EmailValidatorInterface {
  ...
  public function isValid($email, ?EmailValidation $email_validation = NULL) {
    if ($email_validation) {
      throw new \BadMethodCallException('Calling \Drupal\ilr_registrations\EmailValidator::isValid() with the second argument is not supported. See https://www.drupal.org/node/2997196');
    }
