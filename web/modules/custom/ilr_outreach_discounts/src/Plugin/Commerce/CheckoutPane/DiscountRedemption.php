...
namespace Drupal\ilr_outreach_discounts\Plugin\Commerce\CheckoutPane;
...
/**
 * Provides the ILR outreach discount redemption pane.
 *
 ...
 * )
 */
class DiscountRedemption extends CheckoutPaneBase {
  ...
  public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form) {
    $inline_form = $this->inlineFormManager->createInstance('ilr_outreach_discount_redemption', [
