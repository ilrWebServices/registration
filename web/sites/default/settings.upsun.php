...
// CUSTOM SETTINGS FOR UPSUN

// Import variables prefixed with 'drupalsettings:' into $settings and
// 'drupalconfig:' into $config. Adapted from
// https://github.com/platformsh-templates/drupal10/blob/master/web/sites/default/settings.platformsh.php#L133
foreach (json_decode(base64_decode(getenv('PLATFORM_VARIABLES')), true) as $name => $value) {
  $parts = explode(':', $name);
